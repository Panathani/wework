<?php
    ...
    $sql = "SELECT * FROM applicant WHERE compo_id = $compo_id";
    $result = mysqli_query($conn, $sql);
    

    $sql1 = "SELECT `position_id` FROM company_position WHERE compo_id = $compo_id";
    $result1 = mysqli_query($conn, $sql1);
    $row1 = mysqli_fetch_assoc($result1);
    $position_id = $row1['position_id'];

    $sql2 = "SELECT `position` FROM position WHERE position_id = $position_id";
...
<head>
    ...
    <title>ผู้สมัครงาน · WeWork</title>
...
<body>
    ...
    <br><br>
    <?php if (isset($row)) : ?>
    <h1 class="text-center">ผู้สมัคร ตำแหน่ง
            ...
            <tbody id="table_body">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="delete-apppo.php?jobpo_id=<?php echo $row['jobpo_id'] ?>" class="delete"
