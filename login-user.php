...
<head>
    ...
    <title>เข้าสู่ระบบสำหรับผู้หางาน · WeWork</title>
...
<body>
    ...
    <div class="text-center">
        <h1 class="top center"><br>สำหรับผู้หางาน</h1>
        <form class="form-signin" action="login-user_db.php" method="post">
            <br>
            ...
            <br>
            <input class="form-control" type="email" name="email" placeholder="ที่อยู่อีเมล์" required>
            <br>
            <input class="form-control" type="password" name="password" placeholder="รหัสผ่าน" required>
            <br><br>
            <button type="submit" name="login_user" class="w-100 btn btn-success btn-lg">เข้าสู่ระบบ</button>
            <br><br>
            <p>ยังไม่ได้ลงทะเบียน <a href="signup-user.php">ลงทะเบียน</a></p>
        </form>
    </div>
